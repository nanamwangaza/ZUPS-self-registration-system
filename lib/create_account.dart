...
class _CreateAccountState extends State<CreateAccount> {
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (_nenosiri != _hakiki_neno_siri) {
        showDialog(
          context: context,
      ...
      final response = await http.post(
        ...
        body: {
          ...
          'password': _nenosiri,
          'email': _barua_pepe,
          'password_confirmation': _hakiki_neno_siri,
        },
      );
      print(response.body);
      ...
      if (response.statusCode == 200) {
        ...
        var errorMessage =
            error?["error"]?["email"] ?? "Unknown error occurred.";
        ...
        Container(
          decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/zanzibar.jpg'), fit: BoxFit.cover)),
        ),
        Container(
